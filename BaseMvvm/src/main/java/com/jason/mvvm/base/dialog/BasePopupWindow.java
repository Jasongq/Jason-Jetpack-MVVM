...
import com.jason.mvvm.base.dialog.action.ClickAction;
import com.jason.mvvm.base.dialog.action.ContextAction;
import com.jason.mvvm.base.dialog.action.HandlerAction;
...
/**
 * @author :  https://github.com/getActivity/AndroidProject
 * time   : 2019/12/10  15:34
 * desc   : PopupWindow 基类
 * version: 1.0
 */
public class BasePopupWindow extends PopupWindow implements ContextAction, HandlerAction, ClickAction,
