...
import com.jason.mvvm.util.loge
...
import com.jetpack.mvvmdemo.http.state.paresException
import com.jetpack.mvvmdemo.http.state.paresResult
...
suspend fun <T> executeResponse(
    ...
    coroutineScope {
        if (response.getCode()==0) success(response.getData())
